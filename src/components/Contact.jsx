...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "6a81f3a1-90d4-4760-9f4f-fc37f8f678e6");
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
            ...
            <div className='w-full md:w-1/2 text-left md:pl-4'>
                Eamil
                <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="email" name="Eamil" placeholder="Eamil" required/>
            </div>
        </div>
